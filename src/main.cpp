      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          // j[1] is the data JSON object
            ...
            //those will be the anchor points in x and y
            vector<double> ptsx;
            vector<double> ptsy;

            //to keep track of the actual state of the car x, y, yaw
            double ref_x = car_x; 
            double ref_y = car_y;
            ...
            if (prev_size < 2)
            {
              //list two points that make the car tangent to the path
            ...
            {
              //shift car angle reference to 0 degree
            ...
            //create spline object for interpolation 
            tk::spline s; 
